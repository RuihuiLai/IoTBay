...
<html>
    <head>
        ...
        <title>View All Your Orders:</title>
    </head>
    <body>
        <span id="links"> <a href="product_upload.jsp"> upload</a> | <a href="logout.jsp"> Logout</a> <a href="ViewAllOrderServlet"> View All</a></span>
        <h1>Shopping Cart</h1>
        <%
        ...
        <div class="mainTable">
            ...
            <table>
                ...
                <td>
                    <a href="ViewParticularOrderServlet?value=<%=order.getOrderID()%>">
